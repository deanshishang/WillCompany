...
class Hotel(models.Model):
	...
	hotel_name = models.CharField("饭店名称", max_length=150, blank=True)
	...
	modify_user = models.CharField("最后更新", max_length=100, default="system")
	modify_time = models.DateTimeField(auto_now=True)

	def __unicode__(self):
		return u"设备名称:%s;酒店:%s" % (self.name, self.hotel_name)
