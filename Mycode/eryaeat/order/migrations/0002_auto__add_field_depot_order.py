...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Depot.order'
        db.add_column('order_depot', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['order.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Depot.order'
        db.delete_column('order_depot', 'order_id')
