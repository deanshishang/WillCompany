...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('order_order', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Order.orderno'
        db.add_column('order_order', 'orderno',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Order.table'
        db.add_column('order_order', 'table',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['order.Table']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.status'
        db.delete_column('order_order', 'status')

        # Deleting field 'Order.orderno'
        db.delete_column('order_order', 'orderno')

        # Deleting field 'Order.table'
        db.delete_column('order_order', 'table_id')
