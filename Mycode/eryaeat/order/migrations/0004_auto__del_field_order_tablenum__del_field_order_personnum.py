...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.tablenum'
        db.delete_column('order_order', 'tablenum')

        # Deleting field 'Order.personnum'
        db.delete_column('order_order', 'personnum')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Order.tablenum'
        raise RuntimeError("Cannot reverse this migration. 'Order.tablenum' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Order.personnum'
        raise RuntimeError("Cannot reverse this migration. 'Order.personnum' and its values cannot be restored.")
